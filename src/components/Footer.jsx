...
const Footer = () => {
  return (
    <footer className='bg-[#56ABCB] px-7 md:px-16 pt-20' id='contact'>
      ...
      <div className="flex items-center justify-center md:mt-12 mt-20 pb-3 md:text-base text-center text-sm">© {(new Date().getFullYear())} | Designed & coded with ☕ by Edgar Machado</div>
    </footer>
  )
}
